...
public class TimedUndoAdapter extends SimpleSwipeUndoAdapter {
     ...
     */
    public <V extends BaseAdapter & UndoAdapter> TimedUndoAdapter(final V undoAdapter, final Context context, final OnDismissCallback
            dismissCallback) {
    ...
    @Override
    public void onUndo(final View view, final int position) {
