...
public class GripView extends View {
    ...
    public GripView(final Context context) {
        this(context, null);
    }

    public GripView(final Context context, final AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public GripView(final Context context, final AttributeSet attrs, final int defStyleAttr) {
