...
public class SwipeUndoTouchListener extends SwipeDismissTouchListener {
    ...
    public SwipeUndoTouchListener(final ListViewWrapper listViewWrapper, final UndoCallback callback) {
        super(listViewWrapper, callback);
        mCallback = callback;
    }

    @Override
    protected boolean willLeaveDataSetOnFling(final View view, final int position) {
