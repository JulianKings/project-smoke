...
public class SmallConversationArrayAdapter extends ArrayAdapter<ConversationMessage> implements Insertable {
    private final Context context;
    private final List<ConversationMessage> mList;

    public SmallConversationArrayAdapter(Context context, List<ConversationMessage> values) {
