...
public class GroupConversationArrayAdapter extends ArrayAdapter<ConversationMessage> implements Insertable {
    private final Context context;
    private final List<ConversationMessage> mList;

    public GroupConversationArrayAdapter(Context context, List<ConversationMessage> values) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.conversation_group_list_view, parent, false);
