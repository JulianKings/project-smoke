...
//        Emoji.fromChars("\u0023\u20e3"),
     ...
     * @param emojiSize
     */
    public static void addEmojis(Context context, Spannable text, int emojiSize, boolean toText) {
        addEmojis(context, text, emojiSize, 0, -1, toText);
    }
     ...
     * @param length
     */
    public static void addEmojis(Context context, Spannable text, int emojiSize, int index, int length, boolean toText) {
        ...
        for (int i = index; i < textLengthToProcess; i += skip) {
            ...
            if (icon > 0) {
                text.setSpan(new EmojiconSpan(context, icon, emojiSize, toText), i, i + skip, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
            }
        }
    }
}
